        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="rs_footerdiv">
                    <img src="images/footer_logo.png" class="img-responsive" alt="">
                    <p>Despre blabla</p>
                    <p>Solutii custom, design-uri romanesti, valorile noastre, blabla</p>
                    <a href="#" class="rs_readmore">Citeste mai mult
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="row">
                    <div class="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                        <div class="rs_footerdiv">
                            <h5 class="rs_footerheading">Link-uri utile</h5>
                            <ul>
                                <li>
                                    <a href="#">
                                        <i class="fa fa-angle-double-right"> </i>Despre noi
                                        <i class="fa fa-angle-double-right"> </i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <i class="fa fa-angle-double-right"> </i>Termeni si Conditii
                                        <i class="fa fa-angle-double-right"> </i>
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                        <div class="rs_footerdiv">
                            <h5 class="rs_footerheading">Castiga cu noi</h5>
                            <ul>
                                <li>
                                    <a href="#">
                                        <i class="fa fa-angle-double-right"> </i>Esti Artist?
                                        <i class="fa fa-angle-double-right"> </i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <i class="fa fa-angle-double-right"> </i>Esti ONG?
                                        <i class="fa fa-angle-double-right"> </i>
                                    </a>
                                </li>
                            </ul>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="rs_footerdiv widget_tag_cloud">
                    <h5 class="rs_footerheading">Categorii</h5>
                    <a href="#">Apple</a>
                    <a href="#">Huawei</a>
                    <a href="#">Samsung</a>
                </div>
...
{{--<script src="{{asset('/s/plugins/revel/jquery.themepunch.tools.min.js')}}j" type="text/javascript"></script>--}}
